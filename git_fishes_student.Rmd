...
Sp_Tr <- select(comp_data,-c(comment,loc,...1,animal_id,size))
Sp_Tr
...
ft <-  fdata|> 
  ...
  footnote(i = 1, j = 4, 
           part = "header",
           ref_symbols = "1", value = as_paragraph("sl:Standard length of the fish in mm")) |>
  footnote(i = 2, j = grep("_avg", colnames(fdata), value = TRUE), 
           part = "header",
           ref_symbols = "2", value = as_paragraph("avg:Arithmetic Mean")) |> 
  footnote(i = 2, j = grep("_se", colnames(fdata), value = TRUE), 
           part = "header",
           ref_symbols = "3", value = as_paragraph("se:Standard Error")) |> 
